...
class DailySummary(BaseModel):
    ...
    alder_pollen_prior_3d_avg: float | None = None
    alder_pollen_prior_7d_avg: float | None = None
    birch_pollen_prior_3d_avg: float | None = None
    birch_pollen_prior_7d_avg: float | None = None
    grass_pollen_prior_3d_avg: float | None = None
    grass_pollen_prior_7d_avg: float | None = None
    mugwort_pollen_prior_3d_avg: float | None = None
    mugwort_pollen_prior_7d_avg: float | None = None
    olive_pollen_prior_3d_avg: float | None = None
    olive_pollen_prior_7d_avg: float | None = None
    ragweed_pollen_prior_3d_avg: float | None = None
    ragweed_pollen_prior_7d_avg: float | None = None
    overall_pollen_prior_3d_avg: float | None = None
    overall_pollen_prior_7d_avg: float | None = None
    ...
    temperature_2m_overnight_mean: float | None = None
    temperature_daytime_max_prior_3d_avg: float | None = None
    temperature_daytime_max_prior_7d_avg: float | None = None
    temperature_overnight_mean_prior_3d_avg: float | None = None
    temperature_overnight_mean_prior_7d_avg: float | None = None
